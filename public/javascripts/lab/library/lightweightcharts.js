...
$(document).ready(function() {
	...
	var barChartFrame = document.getElementById("barChartFrame");
	var barChart = LightweightCharts.createChart(barChartFrame, {
		localization: {
			locale: messages(MessageKeys.LIGHTWEIGHTCHARTS_LANG),
		},
		width: $(candleStickChartFrame).width(),
		height: $(candleStickChartFrame).height(),
		layout: {
	...
	var barSeries = barChart.addBarSeries({
		thinBars: true,
		downColor: '#000',
		upColor: '#000',
	});
	...
	var candleStickChartFrame = document.getElementById("candleStickChartFrame");
	var candleStickChart = LightweightCharts.createChart(candleStickChartFrame, {
		localization: {
			locale: messages(MessageKeys.LIGHTWEIGHTCHARTS_LANG),
		},
		width: $(candleStickChartFrame).width(),
	...
	var candleSeries = candleStickChart.addCandlestickSeries({
	...
	window.onresize = function() {
		...
		barChart.resize($(barChartFrame).height(), $(barChartFrame).width());
		candleStickChart.resize($(candleStickChartFrame).height(), $(candleStickChartFrame).width());
	};
});
