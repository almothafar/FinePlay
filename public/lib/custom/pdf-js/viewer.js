...
function configure(PDFJS) {
	PDFJS.imageResourcesPath = '/assets/lib/pdf-js/web/images/';
	PDFJS.workerSrc = '/assets/lib/pdf-js/build/pdf.worker.js';
	PDFJS.cMapUrl = '/assets/lib/pdf-js/web/cmaps/';
...
var DEFAULT_URL = '/assets/lib/pdf-js/web/compressed.tracemonkey-pldi-09.pdf';
;
